...
public abstract class QueryService<ENTITY> {
     ...
     * @return a Specification
     */
    protected <X> Specification<ENTITY> buildSpecification(@Nullable Filter<X> filter, Function<Root<ENTITY>, Expression<X>> metaclassFunction) {
        if (filter == null) {
            return null;
     ...
     * @return a Specification
     */
    protected Specification<ENTITY> buildStringSpecification(@Nullable StringFilter filter, SingularAttribute<? super ENTITY, String> field) {
        return buildSpecification(filter, root -> root.get(field));
    }
     ...
     * @return a Specification
     */
    protected Specification<ENTITY> buildSpecification(@Nullable StringFilter filter, Function<Root<ENTITY>, Expression<String>> metaclassFunction) {
        if (filter == null) {
            return null;
        } else if (filter.getEquals() != null) {
            return equalsSpecification(metaclassFunction, filter.getEquals());
